...
if(isset($_COOKIE['ID_your_site'])){ //if there is, it logs you in and directes you to the members page
 ...
 if (isset($_POST['submit'])) {
	...
	// makes sure they filled it in
 	if(!$_POST['username']){
 		die('You did not fill in a username. <a href="login.php">Try again</a>');
 	}
 	if(!$_POST['pass']){
 		die('You did not fill in a password. <a href="login.php">Try again</a>');
 	}
 ...
 if ($check2 == 0){
	die('INVALID ACCESS<br /><br />If you think this is wrong <a href="login.php">try again</a>.');
}
...
while($info = mysql_fetch_array( $check )){
	...
	//gives error if the password is wrong
 	if ($_POST['pass'] != $info['password']){
 		die('INVAILID ACCESS<br /><br />If you think this is wrong <a href="login.php">try again</a>.');
 	}
