...
if ($_POST['direction'] == 'X') {
	mysql_query("INSERT INTO hazards (type, latitude, longitude, direction, message) VALUES ('$_POST[type_haz]', '$_POST[lat_text]', '$_POST[lng_text]', NULL, '$_POST[message]')");
}
else {
	mysql_query("INSERT INTO hazards (type, latitude, longitude, direction, message) VALUES ('$_POST[type_haz]', '$_POST[lat_text]', '$_POST[lng_text]', '$_POST[direction]', '$_POST[message]')");
